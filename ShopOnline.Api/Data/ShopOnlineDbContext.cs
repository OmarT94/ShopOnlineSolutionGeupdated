...
namespace ShopOnline.Api.Data
{
    public class ShopOnlineDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BestellDetailsProduct>().HasKey(s => new { s.ProductId, s.BestellDetailsId });

            modelBuilder.Entity<BestellDetailsProduct>()
            .HasOne<BestellDetails>(sc => sc.BestellDetails)
            .WithMany(s => s.BestellDetailsProducts)
            .HasForeignKey(sc => sc.BestellDetailsId);


            modelBuilder.Entity<BestellDetailsProduct>()
            .HasOne<Product>(sc => sc.Product)
            .WithMany(s => s.BestellDetailsProduct)
            .HasForeignKey(sc => sc.ProductId);
        }
        //private static void ManyToManyRelationship(ShopOnlineDbContext context)
        //{
        //    var bestellung1 = new BestellDetails { BestellNummer = 5 };
        //    context.AddRange(
        //        new Product
        //        {
        //            Name = "test",
        //            BestellDetails = new List<BestellDetails> { bestellung1 }
        //        });
        //    context.SaveChanges();
        //}
        ...
        public DbSet<BestellDetails> BestellDetails { get; set; }
        public DbSet<BestellDetailsProduct> BestellDetailsProducts { get; set; }
