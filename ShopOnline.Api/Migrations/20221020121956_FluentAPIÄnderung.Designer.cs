...
namespace ShopOnline.Api.Migrations
{
    ...
    [Migration("20221020121956_FluentAPIÄnderung")]
    partial class FluentAPIÄnderung
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopOnline.Api.Entities.BestellDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("GesamtSumme")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool?>("IstStorniert")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("ProductMenge")
                        .HasColumnType("int");

                    b.Property<decimal>("Summe")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SummeOhneMwSt")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("VersandKosten")
                        .HasColumnType("decimal(10,2)");

                    b.HasKey("Id");

                    b.ToTable("BestellDetails");
                });

            modelBuilder.Entity("ShopOnline.Api.Entities.BestellDetailsProduct", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");

                    b.Property<int>("BestellDetailsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductId", "BestellDetailsId");

                    b.HasIndex("BestellDetailsId");

                    b.ToTable("BestellDetailsProducts");
                });
            ...
            modelBuilder.Entity("ShopOnline.Api.Entities.User", b =>
                {
                    ...
                    b.Property<string>("E_MailAdresse")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ShopOnline.Api.Entities.BestellDetailsProduct", b =>
                {
                    b.HasOne("ShopOnline.Api.Entities.BestellDetails", "BestellDetails")
                        .WithMany("BestellDetailsProducts")
                        .HasForeignKey("BestellDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopOnline.Api.Entities.Product", "Product")
                        .WithMany("BestellDetailsProduct")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BestellDetails");
            ...
            modelBuilder.Entity("ShopOnline.Api.Entities.BestellDetails", b =>
                {
                    b.Navigation("BestellDetailsProducts");
                });

            modelBuilder.Entity("ShopOnline.Api.Entities.Product", b =>
                {
                    b.Navigation("BestellDetailsProduct");
                });
